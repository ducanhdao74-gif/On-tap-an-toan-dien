...
"""
    ...
    # Thử kết nối với debug level để xem log chi tiết
    print("Đang kết nối tới Gmail SMTP...")
    server = smtplib.SMTP("smtp.gmail.com", 587, timeout=10)
    server.set_debuglevel(1)  # Bật log debug SMTP ra console
    server.starttls()
    print("Đang đăng nhập Gmail...")
    ...
    print(f"LỖI GỬI EMAIL CHI TIẾT: {e}")
    return False
